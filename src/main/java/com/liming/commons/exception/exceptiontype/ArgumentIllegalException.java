...
public class ArgumentIllegalException extends RuntimeException {
    /**
     * Constructs an <code>ArgumentIllegalException</code> with no
     * detail message.
     */
    ...
    /**
     * Constructs an <code>ArgumentIllegalException</code> with the
     * specified detail message.
     *
     * @param   s   the detail message.
     */
    public ArgumentIllegalException(String s) {
        super(s);
    }
     ...
     * @since  1.5
     */
    public ArgumentIllegalException(Throwable cause) {
        super(cause);
    }
